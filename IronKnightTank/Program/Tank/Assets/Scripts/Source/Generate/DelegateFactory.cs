...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<XQFramework.Laucher.ILanucherTask,float,string>), factory.System_Action_XQFramework_Laucher_ILanucherTask_float_string);
		dict.Add(typeof(System.Func<UnityEngine.Transform,bool>), factory.System_Func_UnityEngine_Transform_bool);
		...
		DelegateTraits<System.Action<XQFramework.Laucher.ILanucherTask,float,string>>.Init(factory.System_Action_XQFramework_Laucher_ILanucherTask_float_string);
		DelegateTraits<System.Func<UnityEngine.Transform,bool>>.Init(factory.System_Func_UnityEngine_Transform_bool);
		...
		TypeTraits<System.Action<XQFramework.Laucher.ILanucherTask,float,string>>.Init(factory.Check_System_Action_XQFramework_Laucher_ILanucherTask_float_string);
		TypeTraits<System.Func<UnityEngine.Transform,bool>>.Init(factory.Check_System_Func_UnityEngine_Transform_bool);
		...
		StackTraits<System.Action<XQFramework.Laucher.ILanucherTask,float,string>>.Push = factory.Push_System_Action_XQFramework_Laucher_ILanucherTask_float_string;
		StackTraits<System.Func<UnityEngine.Transform,bool>>.Push = factory.Push_System_Func_UnityEngine_Transform_bool;
	...
	class System_Action_XQFramework_Laucher_ILanucherTask_float_string_Event : LuaDelegate
	{
		public System_Action_XQFramework_Laucher_ILanucherTask_float_string_Event(LuaFunction func) : base(func) { }
		public System_Action_XQFramework_Laucher_ILanucherTask_float_string_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(XQFramework.Laucher.ILanucherTask param0, float param1, string param2)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.Push(param1);
		...
		public void CallWithSelf(XQFramework.Laucher.ILanucherTask param0, float param1, string param2)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public System.Action<XQFramework.Laucher.ILanucherTask,float,string> System_Action_XQFramework_Laucher_ILanucherTask_float_string(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<XQFramework.Laucher.ILanucherTask,float,string> fn = delegate(XQFramework.Laucher.ILanucherTask param0, float param1, string param2) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_XQFramework_Laucher_ILanucherTask_float_string_Event target = new System_Action_XQFramework_Laucher_ILanucherTask_float_string_Event(func);
			System.Action<XQFramework.Laucher.ILanucherTask,float,string> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_XQFramework_Laucher_ILanucherTask_float_string_Event target = new System_Action_XQFramework_Laucher_ILanucherTask_float_string_Event(func, self);
			System.Action<XQFramework.Laucher.ILanucherTask,float,string> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_XQFramework_Laucher_ILanucherTask_float_string(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<XQFramework.Laucher.ILanucherTask,float,string>), L, pos);
	}

	void Push_System_Action_XQFramework_Laucher_ILanucherTask_float_string(IntPtr L, System.Action<XQFramework.Laucher.ILanucherTask,float,string> o)
	{
		ToLua.Push(L, o);
	}

	class System_Func_UnityEngine_Transform_bool_Event : LuaDelegate
	{
	...
	public System.Func<UnityEngine.Transform,bool> System_Func_UnityEngine_Transform_bool(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Func<UnityEngine.Transform,bool> fn = delegate(UnityEngine.Transform param0) { return false; };
			return fn;
		}

		if(!flag)
		{
			System_Func_UnityEngine_Transform_bool_Event target = new System_Func_UnityEngine_Transform_bool_Event(func);
			System.Func<UnityEngine.Transform,bool> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Func_UnityEngine_Transform_bool_Event target = new System_Func_UnityEngine_Transform_bool_Event(func, self);
			System.Func<UnityEngine.Transform,bool> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Func_UnityEngine_Transform_bool(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Func<UnityEngine.Transform,bool>), L, pos);
	}

	void Push_System_Func_UnityEngine_Transform_bool(IntPtr L, System.Func<UnityEngine.Transform,bool> o)
	{
		ToLua.Push(L, o);
	}
