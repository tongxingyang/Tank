...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		ReferenceCounterWrap.Register(L);
		LuaProfilerWrap.Register(L);
		CameraMoverWrap.Register(L);
		TestMgrWrap.Register(L);
		SaveManagerWrap.Register(L);
		TankRadarMapWrap.Register(L);
		...
		L.BeginModule("Lua");
		L.BeginModule("LuaUi");
		Assets_Framework_Lua_LuaUi_LuaUiWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.EndModule();
		L.BeginModule("Scripts");
		L.BeginModule("Game");
		L.BeginModule("Launcher");
		L.BeginModule("Task");
		Assets_Scripts_Game_Launcher_Task_LuaHandoverTaskWrap.Register(L);
		Assets_Scripts_Game_Launcher_Task_LuaModuleTaskProxyWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.BeginModule("Time");
		Assets_Scripts_Game_Time_TankTimeManagerWrap.Register(L);
		L.EndModule();
		L.BeginModule("LuaTools");
		Assets_Scripts_Game_LuaTools_LuaToolsWrap.Register(L);
		L.EndModule();
		L.BeginModule("Tools");
		Assets_Scripts_Game_Tools_LoopSliderWrap.Register(L);
		Assets_Scripts_Game_Tools_UIWorldPosFollowerWrap.Register(L);
		L.EndModule();
		L.BeginModule("Input");
		Assets_Scripts_Game_Input_InputManagerWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.BeginModule("Tools");
		L.BeginModule("Lua");
		...
		L.EndModule();
		L.EndModule();
		L.BeginModule("XQFramework");
		L.BeginModule("Scene");
		XQFramework_Scene_UnitySceneManagerWrap.Register(L);
		L.EndModule();
		L.BeginModule("Resource");
		XQFramework_Resource_ResourcesManagerWrap.Register(L);
		L.EndModule();
		L.BeginModule("Time");
		XQFramework_Time_TimeManagerWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.BeginModule("Game");
		L.BeginModule("Tank");
		Game_Tank_ActionViewPlayerWrap.Register(L);
		Game_Tank_TankMeshWrap.Register(L);
		L.EndModule();
		L.EndModule();
		...
		L.RegFunction("Action_XQFramework_Laucher_ILanucherTask_float_string", System_Action_XQFramework_Laucher_ILanucherTask_float_string);
		L.RegFunction("Func_UnityEngine_Transform_bool", System_Func_UnityEngine_Transform_bool);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_XQFramework_Laucher_ILanucherTask_float_string(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<XQFramework.Laucher.ILanucherTask,float,string>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<XQFramework.Laucher.ILanucherTask,float,string>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Func_UnityEngine_Transform_bool(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Func<UnityEngine.Transform,bool>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Func<UnityEngine.Transform,bool>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
