...
{
	public static string luaDir = AppConst.LuaDir;//Application.dataPath + "/Lua";                //lua逻辑代码目录 FrameworkConst.GameResourceRootDir_Sys + "/Lua/src";                //lua逻辑代码目录
	public static string toluaDir =  FrameworkConst.ToLuaDir ;//Application.dataPath + "/ToLua/Lua";        //tolua lua文件目录 FrameworkConst.FrameworkRootDir + "/ToLua/Lua";        //tolua lua文件目录
