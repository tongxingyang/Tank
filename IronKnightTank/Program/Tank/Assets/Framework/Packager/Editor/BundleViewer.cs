...
{
	[MenuItem("Assets/BundleViewer", false)]
	[MenuItem("Tools/Bundle/BundleViewer", false, 3)]
	static void Init()
	{
		BundleViewer w = EditorWindow.GetWindow<BundleViewer>(false, "AB Viewer", true);
		w.Show();
	}
	
	[MenuItem("Assets/BundleViewer", true)]
