...
namespace Assets.Framework.Lua.LuaUi.Event.Trigger
{
    ...
    public class OnMouseEnterTrigger : MonoBehaviour, ILuaEventTrigger
    {

        private static string Signature = "()";
        private static string Event = "OnMouseEnter";
        ...
        {
            var mouseEnterTrigger = go.AddComponent<OnMouseEnterTrigger>();
