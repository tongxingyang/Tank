// ----------------------------------------------------------------------------
// <copyright file="OnMouseDownTrigger.cs" company="上海序曲网络科技有限公司">
...
namespace Assets.Framework.Lua.LuaUi.Event.Trigger
{
    ...
    public class OnMouseDownTrigger : MonoBehaviour, ILuaEventTrigger
    {
        private static string Signature = "()";
        private static string Event = "OnMouseDown";
        ...
        {
            var spriteClickTrigger = go.AddComponent<OnMouseDownTrigger>();
            spriteClickTrigger.handler = handler;
            spriteClickTrigger.self = self;
            return spriteClickTrigger;
        }
