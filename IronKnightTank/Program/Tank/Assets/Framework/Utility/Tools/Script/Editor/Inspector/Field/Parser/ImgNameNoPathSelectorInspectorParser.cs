// ----------------------------------------------------------------------------
// <copyright file="ImgNameNoPathSelectorInspectorParser.cs" company="上海序曲网络科技有限公司">
// Copyright (C) 2015 上海序曲网络科技有限公司
// All rights are reserved. Reproduction or transmission in whole or in part, in
// any form or by any means, electronic, mechanical or otherwise, is prohibited 
// without the prior written consent of the copyright owner.
// </copyright>
// <author>ShenWei</author>
...
namespace Assets.Tools.Script.Editor.Inspector.Field.Parser
{
    ...
    using UnityEngine;
    public class ImgNameNoPathSelectorInspectorParser : FieldInspectorParser
    {
        public override string Name
        {
            get
            {
                return "ImgNameNoPathSelector";
            }
        }

        GUISearchBar<Texture2D> searchBar2 = new GUISearchBar<Texture2D>();

        private List<string> datas = new List<string>() { "13123", "4342432" }; 
            ...
            bool withName = true)
        {
            ...
            for (int i = 0; i < style.ParserAgrs.Length; i++)
            {
                ...
                sw_Path = imgFolderPaths[i];
                sw_Path = sw_Path.Replace("Assets/GameResource/", "");
            }
            value = sw_Path + "/" + value;
           // value = imgFolderPaths[0] + "/" + value;//this.FieldValueToAssetDatabasePath(currName).Replace(imgFolderPaths[0] + "/", "");
            ...
            string a = this.AssetDatabasePathToFieldValue(currName);
            currName = EditorGUILayout.TextField(currName.Replace(sw_Path + "/",""));
